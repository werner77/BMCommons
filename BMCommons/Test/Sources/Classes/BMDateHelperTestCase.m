...
- (void)testTimezoneCorrection {
	...
	GHAssertTrue([@"2010-03-28 00:59:59" isEqual:correctedDateString], @"Date correction is not as expected");
	...
	GHAssertTrue([@"2010-03-28 01:00:00" isEqual:correctedDateString], @"Date correction is not as expected");
