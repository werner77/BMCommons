...
- (void)testCache {
    ...
    GHAssertTrue(cache.count == 3, @"Expected cache count to be half + 1");
    GHAssertTrue([cache objectForKey:@"1"] != nil, @"Expected '1' to still be in the cache");
    GHAssertTrue([cache objectForKey:@"2"] == nil, @"Expected '2' to not be in the cache");
    GHAssertTrue([cache objectForKey:@"3"] == nil, @"Expected '3' to not be in the cache");
}
