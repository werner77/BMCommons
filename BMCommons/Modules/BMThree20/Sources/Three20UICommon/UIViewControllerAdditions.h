...
@interface UIViewController (BMTTCategory)
 ...
 * custom UIViewController subclasses the chance to tell BMTTNavigator how to follow the hierarchy
 * of view controllers.
 */
 ...
 * subclasses the chance to tell BMTTNavigator how to follow the hierarchy of view controllers.
 */
 ...
 *
 * BMTTURLMap uses this to display newly created controllers.  The default does nothing --
 ...
 *
 * BMTTURLMap uses this to display controllers that exist already, but may not be visible.
 ...
 *
 * This will be called when BMTTNavigator is persisting the navigation history so that it
 ...
 *
 * This will be called when BMTTNavigator is restoring the navigation history.  This may
...
/**
 * Finishes initializing the controller after a BMTTNavigator-coordinated delay.
 *
 * If the controller was created in between calls to BMTTNavigator beginDelay and endDelay, then
