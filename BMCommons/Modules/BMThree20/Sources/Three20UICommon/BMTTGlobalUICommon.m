...
CGFloat BMTTToolbarHeightForOrientation(UIInterfaceOrientation orientation) {
  if (UIInterfaceOrientationIsPortrait(orientation) || BMTTIsPad()) {
    return BMTT_ROW_HEIGHT;

  } else {
    return BMTT_LANDSCAPE_TOOLBAR_HEIGHT;
  }
}
...
CGFloat BMTTKeyboardHeightForOrientation(UIInterfaceOrientation orientation) {
  if (BMTTIsPad()) {
    return UIInterfaceOrientationIsPortrait(orientation) ? BMTT_IPAD_KEYBOARD_HEIGHT
                                                         : BMTT_IPAD_LANDSCAPE_KEYBOARD_HEIGHT;

  } else {
    return UIInterfaceOrientationIsPortrait(orientation) ? BMTT_KEYBOARD_HEIGHT
                                                         : BMTT_LANDSCAPE_KEYBOARD_HEIGHT;
  }
}
...
CGFloat BMTTGroupedTableCellInset() {
  return BMTTIsPad() ? ttkGroupedPadTableCellInset : ttkGroupedTableCellInset;
}

///////////////////////////////////////////////////////////////////////////////////////////////////
void BMTTAlert(NSString* message) {
  UIAlertView* alert = [[[UIAlertView alloc] initWithTitle:BMTTLocalizedString(@"Alert", @"")
                                             message:message delegate:nil
                                             cancelButtonTitle:BMTTLocalizedString(@"OK", @"")
