...
///////////////////////////////////////////////////////////////////////////////////////////////////
+ (BMTTInsetStyle*)styleWithInset:(UIEdgeInsets)inset next:(BMTTStyle*)next {
  BMTTInsetStyle* style = [[[self alloc] initWithNext:next] autorelease];
  style.inset = inset;
  return style;
}
