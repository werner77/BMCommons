...
@protocol BMTTPostControllerDelegate <NSObject>
@optional
 ...
 */
- (CGRect)postController:(BMTTPostController*)postController willAnimateTowards:(CGRect)rect;

/**
 * The text has been posted.
 */
- (void)postController: (BMTTPostController*)postController
