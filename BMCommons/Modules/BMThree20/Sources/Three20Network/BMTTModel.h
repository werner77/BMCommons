...
// Network
#import <BMCommons/Three20Network/BMTTURLRequestCachePolicy.h>

/**
 * BMTTModel describes the state of an object that can be loaded from a remote source.
 *
 * By implementing this protocol, you can communicate to the user the state of network
 * activity in an object.
 */
@protocol BMTTModel <NSObject>

/**
 * An array of objects that conform to the BMTTModelDelegate protocol.
 */
...
/**
 * A default implementation of BMTTModel does nothing other than appear to be loaded.
 */
@interface BMTTModel : NSObject <BMTTModel> {
