...
#import "Three20Core/BMTTMarkupStripper.h"

// Core
#import "Three20Core/BMTTCorePreprocessorMacros.h"
#import "Three20Core/BMTTEntityTables.h"



@implementation BMTTMarkupStripper


///////////////////////////////////////////////////////////////////////////////////////////////////
- (void)dealloc {
  BMTT_RELEASE_SAFELY(_strings);
...
- (NSData*)             parser: (NSXMLParser*)parser
  ...
  return [[[BMTTEntityTables sharedInstance] iso88591] objectForKey:entityName];
}
