...
#import <BMCommons/Three20Core/BMTTCorePreprocessorMacros.h> // For __BMTTDEPRECATED_METHOD
 ...
 */
@interface NSString (BMTTAdditions)
 ...
 * @deprecated Use BMTTIsStringWithAnyText() instead. Updating your use of
 ...
 * becomes
 *
 * if (BMTTIsStringWithAnyText(textField.text) && !textField.text.isWhitespaceAndNewlines) {
 *
 * and
 *
 * if (textField.text.isEmptyOrWhitespace) {
 ...
 */
- (BOOL)isEmptyOrWhitespace __BMTTDEPRECATED_METHOD;
 ...
 */
- (NSDictionary*)queryDictionaryUsingEncoding:(NSStringEncoding)encoding __BMTTDEPRECATED_METHOD;
