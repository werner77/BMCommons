...
#define BM_HTTP_METHOD_PATCH @"PATCH"
#define BM_HTTP_METHOD_OPTIONS @"OPTIONS"
#define BM_HTTP_METHOD_HEAD @"HEAD"
#define BM_HTTP_METHOD_TRACE @"TRACE"
#define BM_HTTP_METHOD_CONNECT @"CONNECT"
