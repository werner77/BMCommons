...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@interface UITouch (BMTTCategory)
...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation UITouch (BMTTCategory)
...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation UIEvent (BMTTCategory)
 ...
 * Additions.
 */
BMTT_FIX_CATEGORY_BUG(UIViewAdditions)

@implementation UIView (BMTTCategory)
...
- (CGFloat)orientationWidth {
  return UIInterfaceOrientationIsLandscape(BMTTInterfaceOrientation())
...
- (CGRect)frameWithKeyboardSubtracted:(CGFloat)plusHeight {
  CGRect frame = self.frame;
  if (BMTTIsKeyboardVisible()) {
    CGRect screenFrame = BMTTScreenBounds();
    CGFloat keyboardTop = (screenFrame.size.height - (BMTTKeyboardHeight() + plusHeight));
...
- (NSDictionary *)userInfoForKeyboardNotification {
  ...
  CGPoint centerEnd = CGPointMake(floor(screenFrame.size.width/2 - self.width/2),
                                  screenFrame.size.height - floor(self.height/2));
  CGRect frameBegin = CGRectOffset(bounds, centerBegin.x - bounds.size.width/2,
                                   centerBegin.y - bounds.size.height/2);
  CGRect frameEnd = CGRectOffset(bounds, centerEnd.x - bounds.size.width/2,
                                 centerEnd.y - bounds.size.height/2);
