...
@protocol BMTTScrollViewDelegate;
@protocol BMTTScrollViewDataSource;

@interface BMTTScrollView : UIView {
  ...
  id<BMTTScrollViewDelegate>    _delegate;
  id<BMTTScrollViewDataSource>  _dataSource;
...
@property (nonatomic, assign) id<BMTTScrollViewDelegate>    delegate;
@property (nonatomic, assign) id<BMTTScrollViewDataSource>  dataSource;
