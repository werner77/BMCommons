...
// UI
#import <BMThree20/Three20UI/BMTTViewController.h>

// Network
#import <BMThree20/Three20Network/BMTTModelDelegate.h>
 ...
 */
@interface BMTTModelViewController : BMTTViewController <BMTTModelDelegate> {
  id<BMTTModel> _model;
  NSError*    _modelError;
...
@property (nonatomic, retain) id<BMTTModel> model;
