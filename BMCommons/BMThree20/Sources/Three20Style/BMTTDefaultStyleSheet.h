...
// Style
#import <BMThree20/Three20Style/BMTTStyleSheet.h>

@class BMTTShape;

@interface BMTTDefaultStyleSheet : BMTTStyleSheet
...
@property (nonatomic, readonly) UIColor*  navigationBarTextTintColor;
