...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation BMTTShadowStyle
...
///////////////////////////////////////////////////////////////////////////////////////////////////
+ (BMTTShadowStyle*)styleWithColor:(UIColor*)color blur:(CGFloat)blur offset:(CGSize)offset
                            next:(BMTTStyle*)next {
  BMTTShadowStyle* style = [[[self alloc] initWithNext:next] autorelease];
  style.color = color;
  style.blur = blur;
  style.offset = offset;
  return style;
...
- (void)draw:(BMTTStyleContext*)context {
  ...
  context.frame = BMTTRectInset(context.frame, inset);
  context.contentFrame = BMTTRectInset(context.contentFrame, inset);
