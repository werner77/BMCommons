...
///////////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
@implementation BMTTReflectiveFillStyle
...
///////////////////////////////////////////////////////////////////////////////////////////////////
+ (BMTTReflectiveFillStyle*)styleWithColor:(UIColor*)color next:(BMTTStyle*)next {
  BMTTReflectiveFillStyle* style = [[[self alloc] initWithNext:next] autorelease];
  style.color = color;
...
///////////////////////////////////////////////////////////////////////////////////////////////////
+ (BMTTReflectiveFillStyle*)styleWithColor:(UIColor*)color
                     withBottomHighlight:(BOOL)withBottomHighlight next:(BMTTStyle*)next {
  BMTTReflectiveFillStyle* style = [[[self alloc] initWithNext:next] autorelease];
  style.color = color;
