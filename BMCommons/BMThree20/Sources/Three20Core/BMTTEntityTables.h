 ...
 */
@interface BMTTEntityTables : NSObject {
...
@interface BMTTEntityTables (BMTTSingleton)

// Access the singleton instance: [[BMTTEntityTables sharedInstance] <methods>]
+ (BMTTEntityTables*)sharedInstance;
