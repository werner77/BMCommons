 ...
 */
@interface BMTTBaseViewController : UIViewController {
@protected
  NSDictionary*     _frozenState;
  UIBarStyle        _navigationBarStyle;
  UIColor*          _navigationBarTintColor;
  UIColor*          _navigationBarTextTintColor;
 ...
 * a navigation controller.
 *
 * @default BMTTSTYLEVAR(navigationBarTintColor)
 */
@property (nonatomic, retain) UIColor* navigationBarTintColor;

/**
 Text tint color for the navigation bar (only used on iOS >= 7).
 */
@property (nonatomic, retain) UIColor* navigationBarTextTintColor;
